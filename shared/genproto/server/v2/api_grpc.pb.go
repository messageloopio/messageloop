...
const (
	APIService_Publish_FullMethodName     = "/messageloop.server.v2.APIService/Publish"
	APIService_Disconnect_FullMethodName  = "/messageloop.server.v2.APIService/Disconnect"
	APIService_Subscribe_FullMethodName   = "/messageloop.server.v2.APIService/Subscribe"
	APIService_Unsubscribe_FullMethodName = "/messageloop.server.v2.APIService/Unsubscribe"
	APIService_Survey_FullMethodName      = "/messageloop.server.v2.APIService/Survey"
	APIService_GetPresence_FullMethodName = "/messageloop.server.v2.APIService/GetPresence"
	APIService_GetHistory_FullMethodName  = "/messageloop.server.v2.APIService/GetHistory"
	APIService_GetChannels_FullMethodName = "/messageloop.server.v2.APIService/GetChannels"
)
...
var APIService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "messageloop.server.v2.APIService",
