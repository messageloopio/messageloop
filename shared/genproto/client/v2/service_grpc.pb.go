...
const (
	MessageLoopService_MessageLoop_FullMethodName = "/messageloop.client.v2.MessageLoopService/MessageLoop"
)
...
var MessageLoopService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "messageloop.client.v2.MessageLoopService",
	...
	Metadata: "client/v2/service.proto",
}
