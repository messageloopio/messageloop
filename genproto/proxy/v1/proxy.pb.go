...
const file_proxy_v1_proxy_proto_rawDesc = "" +
	...
	"\x0eOnDisconnected\x12+.messageloop.proxy.v1.OnDisconnectedRequest\x1a,.messageloop.proxy.v1.OnDisconnectedResponseB>Z<github.com/fleetlit/messageloop/genproto/go/proxy/v1;proxypbb\x06proto3"
