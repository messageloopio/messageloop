...
// 	protoc        (unknown)
// source: includes/cloudevents/cloudevents.proto
...
func (x *CloudEvent) Reset() {
	*x = CloudEvent{}
	mi := &file_includes_cloudevents_cloudevents_proto_msgTypes[0]
...
func (*CloudEvent) Descriptor() ([]byte, []int) {
	return file_includes_cloudevents_cloudevents_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudEventAttributeValue) Reset() {
	*x = CloudEventAttributeValue{}
	mi := &file_includes_cloudevents_cloudevents_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudEventAttributeValue) Descriptor() ([]byte, []int) {
	return file_includes_cloudevents_cloudevents_proto_rawDescGZIP(), []int{1}
}
...
var File_includes_cloudevents_cloudevents_proto protoreflect.FileDescriptor

const file_includes_cloudevents_cloudevents_proto_rawDesc = "" +
	"\n" +
	"&includes/cloudevents/cloudevents.proto\x12\x11io.cloudevents.v1\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa7\x03\n" +
	"\n" +
	"CloudEvent\x12\x0e\n" +
	...
	"\x04attrB=Z;github.com/cloudevents/sdk-go/binding/format/protobuf/v2/pbb\x06proto3"

var (
	file_includes_cloudevents_cloudevents_proto_rawDescOnce sync.Once
	file_includes_cloudevents_cloudevents_proto_rawDescData []byte
)

func file_includes_cloudevents_cloudevents_proto_rawDescGZIP() []byte {
	file_includes_cloudevents_cloudevents_proto_rawDescOnce.Do(func() {
		file_includes_cloudevents_cloudevents_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_includes_cloudevents_cloudevents_proto_rawDesc), len(file_includes_cloudevents_cloudevents_proto_rawDesc)))
	})
	return file_includes_cloudevents_cloudevents_proto_rawDescData
}

var file_includes_cloudevents_cloudevents_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_includes_cloudevents_cloudevents_proto_goTypes = []any{
...
var file_includes_cloudevents_cloudevents_proto_depIdxs = []int32{
...
func init() { file_includes_cloudevents_cloudevents_proto_init() }
func file_includes_cloudevents_cloudevents_proto_init() {
	if File_includes_cloudevents_cloudevents_proto != nil {
		return
	}
	file_includes_cloudevents_cloudevents_proto_msgTypes[0].OneofWrappers = []any{
		(*CloudEvent_BinaryData)(nil),
		(*CloudEvent_TextData)(nil),
		(*CloudEvent_ProtoData)(nil),
	}
	file_includes_cloudevents_cloudevents_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_includes_cloudevents_cloudevents_proto_rawDesc), len(file_includes_cloudevents_cloudevents_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_includes_cloudevents_cloudevents_proto_goTypes,
		DependencyIndexes: file_includes_cloudevents_cloudevents_proto_depIdxs,
		MessageInfos:      file_includes_cloudevents_cloudevents_proto_msgTypes,
	}.Build()
	File_includes_cloudevents_cloudevents_proto = out.File
	file_includes_cloudevents_cloudevents_proto_goTypes = nil
	file_includes_cloudevents_cloudevents_proto_depIdxs = nil
}
