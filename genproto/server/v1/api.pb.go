...
const file_server_v1_api_proto_rawDesc = "" +
	...
	"\vUnsubscribe\x12'.messageloop.server.v1.SubscribeRequest\x1a*.messageloop.server.v1.UnsubscribeResponseBDZBgithub.com/fleetlit/messageloop/genproto/go/server/v1;serverpbb\x06proto3"
