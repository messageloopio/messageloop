...
| [PR-KA-D13 实现规格](tasks/pr-ka-d13-cluster-contracts.md) | Ready | KD-K26 阶段三(a)：cluster 契约下沉 internal/cluster + metrics 下沉 internal/metrics；[prompt](tasks/pr-ka-d13-prompt.md) |
