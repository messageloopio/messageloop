...
| [PR-KA-D14 实现规格](tasks/pr-ka-d14-session-plane.md) | Ready | KD-K26 阶段三(b)：session plane 下沉 internal/session + Session.node 依赖反转；[prompt](tasks/pr-ka-d14-prompt.md) |
